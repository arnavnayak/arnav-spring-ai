package arnav.springai.springaitool.tool;
...
public class TimeTools {
    ...
    String getCurrentLocalTime(){
        LOGGER.info("Returning current time in the timezone ");
        return LocalTime.now().toString();
    }

    @Tool(name = "getCurrentGivenTimeZone", description = "Get the current time in the user given timezone")
    String getCurrentGivenTimeZone(@ToolParam(
